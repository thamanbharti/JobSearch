...
export default function NavBar({filterdata}) {
  ...
  const num=JSON.parse(localStorage.getItem('userCredential')).notificationNo;
  const firstChar=JSON.parse(localStorage.getItem('userCredential')).username[0];
  ...
  const renderMobileMenu = (
    ...
    >
      ...
      <MenuItem>
        ...
        <IconButton
          size="large"
          aria-label={`show ${num} new notifications`}
          color="inherit"
        >
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            ...
            <IconButton>
            <MdRecommend size={25} color='white' onClick={()=>navigate('/recommend')}/>
            </IconButton>
            <IconButton
              size="large"
              aria-label={`show ${num} new notifications`}
          ...
          color="inherit">
            ...
            >
              ...
              {/* <AccountCircle /> */}
              <Avatar sx={{ bgcolor: 'deepOrange' }}>{firstChar}</Avatar>
            </IconButton>
          </Box>
