...
useEffect(()=>{
    ...
    const handlePostJob = () => {
        ...
        if(jobDetails.companyName&&jobDetails.description&&jobDetails.location&&jobDetails.requirement&&jobDetails.salary&&jobDetails.eligibility)
          {
            setPosting(true);
              ...
              <button className='apply-button' onClick={() => {
                ...
                <div className='card-container-1' style={{ height: 'max-content' }}>
                    <div className='job-card'>
                        ...
                        <select
  className='title'
  style={{ width: '100%', height: '5vh', marginTop: '2vh', color: 'purple', fontWeight: '900' }}
